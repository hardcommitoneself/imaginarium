...
const TinyMceEditor = (props) => {
    ...
    return (
        <div className="w-[65%]  h-[calc(100vh-112px)]" >
            <div className="CustomScroll h-full w-full overflow-y-auto flex  justify-center ml-[-6px]">
                <Editor
                    apiKey="1fh52zkwtcwiski4p6orfwfxd8vcerxbdw33uug1lc7g6yoi"
                    onInit={(evt, editor) => editorRef.current = editor}
                    init={{
                        autosave_ask_before_unload: true,
                        plugins: "lists autoresize advlist anchor autolink autosave charmap code quickbars wordcount visualchars visualblocks",
                        ...
                        content_style: 'body{ color: white; background: #2b2b2b; font-size: 18px; font-family:Helvetica; }',
