...
import { CommentIcon, CopyLinkIcon, DetailIcon, DropDownIcon, IconicIcon, MoreVerticalIcon, PenIcon, SettingIcon, TimesIcon } from "../../../Svg";
            ...
            comment: [
                {
                    count: 1,
                    replies: 2,
                    content: "Need to change this paragraph. Because we already updated hero information.",
                    name: "Irina",
                    duration: "2 days ago",
                },
                {
                            ...
                            <div className="flex flex-col px-[24px] py-[16px] w-full">
                                <div className="w-full h-full flex flex-col gap-4">
                                    <div className="text-sm text-[#CDCDCD]">
                                        Select which omment threads on this file you'll receive emails and notifications for
                                    </div>
                                        ...
                                        <div className="flex flex-col items-start mt-3 gap-3">
                                            <div className="flex">
                                                <input
                                                    ...
                                                    id="all_comment"
                                                />
                                                <label htmlFor="all_comment" className="ml-3 text-[12px] leading-5 text-white">
                                                    All Comments
                                                </label>
                                            </div>
                                            <div className="flex">
                                                <input
                                                    ...
                                                    id="only_yours"
                                                />
                                                <label htmlFor="only_yours" className="ml-3 text-[12px] leading-5 text-white">
                                                    Only yours <span className="text-sm text-[#5F5F5F]">(threads you're involved in)</span>
                                                </label>
                                            </div>
                                            <div className="flex">
                                                <input
                                                    ...
                                                    id="radio_none"
                                                />
                                                <label htmlFor="radio_none" className="ml-3 text-[12px] leading-5 text-white">
                                                    None
                                                </label>
                                            </div>
                                        </div>
                            ...
                            </div>
                            {
                                comm.comment.map((box, index) => (
                                    <div className="dropdown flex flex-col gap-3" key={index} >
                                        <div className=" border border-[#2B2B2B]  flex flex-col p-4 gap-4  rounded-md cursor-pointer" key={index} tabIndex="0">
                                            <div className="flex justify-between">
                                                <div className={(index % 2 === 1 ? " text-[#1DAEFF] " : " ") + "flex items-center justify-center gap-2"}>
                                                    <CommentIcon />
                                                    <label>{box.count}</label>
                                                </div>
                                                <div className="flex justify-between gap-2">
                                                    <label className="uppercase text-xs tracking-[.21rem]" >{box.replies}</label>
                                                    <label className="uppercase text-xs tracking-[.21rem]">Replies</label>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex justify-between">
                                                <div className="flex items-center justify-center gap-2">
                                                    <label className="text-xs uppercase tracking-[.21rem]">{box.name}</label>
                                                </div>
                                                <div className="flex justify-between gap-2">
                                                    <label className="uppercase text-xs tracking-[.21rem]">{box.duration}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
